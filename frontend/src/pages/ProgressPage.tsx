...
const ProgressPage: React.FC = () => {
  ...
  // 백엔드에서 게시글 가져오기 (완독 여부 및 endDate 포함)
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      >
        <h2 style={{ fontSize: '22px', fontWeight: 'bold', marginBottom: '40px' }}>Goal Management</h2>
        ...
        >
          <div style={{ display: 'flex', alignItems: 'baseline', marginBottom: '10px' }}>
            <h3 style={{ fontSize: '20px', fontWeight: 'bold', margin: 0 }}>올해 목표</h3>
            <span style={{ fontSize: '14px', color: '#555', marginLeft: '8px' }}>Annual Goal</span>
          </div>
        ...
        >
          <div style={{ display: 'flex', alignItems: 'baseline', marginBottom: '10px' }}>
            <h3 style={{ fontSize: '20px', fontWeight: 'bold', margin: 0 }}>이번달 목표</h3>
            <span style={{ fontSize: '14px', color: '#555', marginLeft: '8px' }}>Monthly Goal</span>
          </div>
          <hr style={{ border: '0.5px solid #ccc', marginBottom: '20px' }} />
      ...
      <div style={{ flex: 1 }}>
        ...
        {/* Genre Reading Ratio */}
        <h4 style={{ fontSize: '18px', margin: '0 0 20px 0', fontWeight: 'bold' }}>
            장르별 독서 비율
        </h4>
        <div
          style={{
