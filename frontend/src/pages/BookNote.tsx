                    ...
                    {menuPostId === post.id && (
                      ...
                      >
                        ...
                        >
                          ...
                          <img src={`${process.env.PUBLIC_URL}/modify_icon.png`} alt="modify" style={{ width: '16px', height: '16px' }} />
                        </div>
                        <div
                          style={{
                            display: 'flex',
                        ...
                        >
                          ...
                          <img src={`${process.env.PUBLIC_URL}/delete_icon.png`} alt="delete" style={{ width: '16px', height: '16px' }} />
                        </div>
                      </div>
                    )}
                  </div>
